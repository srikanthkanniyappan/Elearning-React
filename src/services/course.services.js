...
// const getCourseVideos = async (courseName) => {
//   try {
//     console.log("encodeURIComponent:",encodeURIComponent(courseName));
//     const response = await api.get(`/courses/course-videos/${encodeURIComponent(courseName)}/`);
//     return response.data;
//   } catch (error) {
//     console.error(`Error fetching videos for course ${courseName}`, error);
//     throw error;
//   }
// };
...
const getLastWatched = async (courseId) => {
  try {
    ...
    console.error(`Error fetching last watched video for course ${courseId}`, error);
    throw error;
  }
};
