  ...
  >
    Q&A
      ...
      <div id="default-tab-content">
        ...
        <div
          className={`lg:hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800 ${activeTab === 'sidebar-content' ? 'block' : 'hidden'}`}
          id="sidebar-content"
          role="tabpanel"
        ...
        {/* Overview Tab */}
        <div
          className={`p-4 rounded-lg bg-gray-50 dark:bg-gray-800 ${activeTab === 'overview' ? 'block' : 'hidden'}`}
          id="overview"
          role="tabpanel"
        ...
        {/* Q&A Tab */}
        <div
          className={`p-4 rounded-lg bg-gray-50 dark:bg-gray-800 ${activeTab === 'qa' ? 'block' : 'hidden'}`}
          id="qa"
          role="tabpanel"
