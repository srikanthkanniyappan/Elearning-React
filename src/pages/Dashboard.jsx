    ...
    <div className="h-screen w-full bg-gray-100 dark:bg-gray-900 flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full max-w-4xl">
        ...
        >
          ...
          <p className="text-sm mt-2">Access and manage all the courses you're enrolled in.</p>
        </div>

        {/* Profile Button - Updated Color */}
        <div
        ...
        >
          ...
          <p className="text-sm mt-2">View and edit your profile information.</p>
        </div>
      </div>
    </div>
  );
