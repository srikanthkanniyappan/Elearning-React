    ...
    try {
      ...
      setCourses((prevCourses) =>
        prevCourses.map((course) =>
          course.id === selectedCourse ? { ...course, is_enrolled: true } : course
        )
      );

      setSelectedCourse(null); // Close the popup on success
    } catch (error) {
    ...
    <div className="bg-gray-100 dark:bg-gray-900 pt-24 h-full">
      ...
      {alert && (
        ...
        >
          ...
          <div className="ms-3 text-xs sm:text-sm font-medium">{alert.message}</div>
